const PerkWidget = () => {
  return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 pt-6 pb-2 ">
        <div className="flex gap-2 items-center border rounded-2xl p-4">
          <svg
